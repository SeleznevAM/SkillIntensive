package com.example.alex.skillintensive.data.storage.models;
...
public class UserDTO implements Parcelable {
    ...
    public UserDTO(UserListRes.UserData user) {
        ...
        mRating = String.valueOf(user.getProfileValues().getRait());
        ...
        for (UserModelResp.Repo repo : user.getRepositories().getRepo()) {
